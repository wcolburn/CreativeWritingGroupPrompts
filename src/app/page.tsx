  ...
  return (
    <div>
     ...
     <main>
      {
        user ? (
          <div>Welcome! Please use the Navigation Bar to visit a page.</div>
        ) : (
          <WelcomeNewUser />
        )
      }
...
function WelcomeNewUser() {
  return (
    <div>
      ...
      <Typography>On Friday and Saturday, a randomly selected user can input a new prompt</Typography>
